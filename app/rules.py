...
rules.add_perm("task.detail", (is_course_participant & is_task_published) | is_course_teaching_staff)
rules.add_perm("task.download.template", (is_course_participant & is_task_published) | is_course_teaching_staff)
...
rules.add_perm("submission.list", (is_course_participant & is_task_published) | is_course_teaching_staff)
